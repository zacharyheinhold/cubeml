...
def batch_inference(directory, school_pickle, method, string_to_exclude=None):
    """
    ...
    for filename in files:
        ...
        if filename.endswith("_Broadband.hdr"):
            ...
            img = false_color_image(predictions=inference_map, colors=learner.colors)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--string_to_exclude', type=str, help='Optional: A string to identify files to be excluded from processing.')
    ...
    batch_inference(args.dir, args.pickle, args.method, args.string_to_exclude)
